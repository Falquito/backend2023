 ...
 */
package com.miportfilio2023.joel.Security.Controller;

/*
import com.miportfilio2023.joel.Security.Dto.JwtDto;
import com.miportfilio2023.joel.Security.Dto.LoginUsuario;
import com.miportfilio2023.joel.Security.Dto.NuevoUsuario;
...
import com.miportfilio2023.joel.Security.Service.RolService;
import com.miportfilio2023.joel.Security.Service.UsuarioService;
import com.miportfilio2023.joel.Security.jwt.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario,BindingResult bindingResult){
        if (bindingResult.hasErrors())
                return new ResponseEntity(new Mensaje("campo mal puesto o datos invalidos"),HttpStatus.BAD_REQUEST);
        if (usuarioService.existsByNombreUsuario(nuevoUsuario.getNombreUsuario()))
            return new ResponseEntity(new Mensaje("El nombre de usuario no esta disponible"),HttpStatus.BAD_REQUEST);
        if (usuarioService.existsByEmail(nuevoUsuario.getEmail()))
            return new ResponseEntity(new Mensaje("El gmail no esta disponible"),HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult){
        if(bindingResult.hasErrors())
            return new ResponseEntity(new Mensaje ("LLena bien los campos"),HttpStatus.BAD_REQUEST);
